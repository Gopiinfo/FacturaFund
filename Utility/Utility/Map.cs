...
namespace Utility
{
    ...
    public struct CommandDefinition
    {
        ...
        {
            if (parameters is Map.IParameterCallbacks)
            {
                ((Map.IParameterCallbacks)parameters).OnCompleted();
            }
        }
       ...
       /// For asynchronous operations, the cancellation-token
        ...
        internal IDbCommand SetupCommand(IDbConnection cnn, Action<IDbCommand, object> paramReader)
        {
            ...
            else if (Map.Settings.CommandTimeout.HasValue)
            {
                cmd.CommandTimeout = Map.Settings.CommandTimeout.Value;
            }
        ...
        static Map.Link<Type, Action<IDbCommand>> commandInitCache;
        static Action<IDbCommand> GetInit(Type commandType)
        {
            if (commandType == null) return null; // GIGO
            Action<IDbCommand> action;
            if (Map.Link<Type, Action<IDbCommand>>.TryGet(commandInitCache, commandType, out action))
            {
                return action;
            }
            ...
            // cache it            
            Map.Link<Type, Action<IDbCommand>>.TryAdd(ref commandInitCache, commandType, ref action);
            return action;
        }
    ...
    /// <summary>
    /// MTXDL, a light weight object mapper for ADO.NET
    /// </summary>
    static partial class Map
    {
        /// Permits specifying certain Map values globally.
        ...
        /// Implement this interface to pass an arbitrary db specific set of parameters to MTXDL
        ...
        /// Implement this interface to pass an arbitrary db specific parameter to MTXDL
        ...
        /// Return a count of all the cached queries by MTXDL
        /// <returns></returns>
        public static int GetCachedSQLCount()
        {
            return _queryCache.Count;
        }
        /// Return a list of all the queries cached by MTXDL
...
#pragma warning restore 618
        ...
        /// Identity of a cached query in MTXDL, used for extensibility
        public partial class Identity : IEquatable<Identity>
        {
            ...
            private Identity(string sql, CommandType? commandType, string connectionString, Type type, Type parametersType, Type[] otherTypes, int gridIndex)
            {
                ...
                unchecked
                {
                    ...
                    hashCode = hashCode * 23 + (connectionString == null ? 0 : Map.connectionStringComparer.GetHashCode(connectionString));
            ...
            public bool Equals(Identity other)
            {
                return
                    ...
                    Map.connectionStringComparer.Equals(connectionString, other.connectionString) &&
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// <returns>An <see cref="IDataReader"/> that can be used to iterate over the results of the SQL query.</returns>
        /// <remarks>
        /// This is typically used when the results of a query are not processed by MTXDL, for example, used to fill a <see cref="DataTable"/>
        /// or <see cref="DataSet"/>.
        /// </remarks>
        /// <example>
        /// <code>
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        {
            return Query<MTXDLRow>(cnn, sql, param as object, transaction, buffered, commandTimeout, commandType);
        }
#else
...
this IDbConnection cnn, string sql, object param, IDbTransaction transaction, int? commandTimeout, CommandType? commandType
        ...
        private static IEnumerable<T> QueryImpl<T>(this IDbConnection cnn, CommandDefinition command, Type effectiveType)
        {
            ...
            try
            {
                ...
                {
                    if (reader.FieldCount == 0) //https URL ://code.google.com/p/MTXDL-dot-net/issues/detail?id=57
                        yield break;
...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        private static Func<IDataReader, object> GetDeserializer(Type type, IDataReader reader, int startBound, int length, bool returnNullIfFirstMissing)
        {
            ...
            if (type == typeof(object)
                || type == typeof(MTXDLRow))
            {
                return GetMTXDLRowDeserializer(reader, startBound, length, returnNullIfFirstMissing);
            }
#else
...
#if !CSHARP30
        private sealed partial class MTXDLTable
        {
            string[] fieldNames;
            ...
            public MTXDLTable(string[] fieldNames)
            {
        ...
        sealed partial class MTXDLRowMetaObject : System.Dynamic.DynamicMetaObject
        {
            static readonly MethodInfo getValueMethod = typeof(IDictionary<string, object>).GetProperty("Item").GetGetMethod();
            static readonly MethodInfo setValueMethod = typeof(MTXDLRow).GetMethod("SetValue", new Type[] { typeof(string), typeof(object) });

            public MTXDLRowMetaObject(
        ...
        private sealed partial class MTXDLRow
            : System.Dynamic.IDynamicMetaObjectProvider
            , IDictionary<string, object>
        {
            readonly MTXDLTable table;
            object[] values;

            public MTXDLRow(MTXDLTable table, object[] values)
            {
            ...
            {
                var sb = GetStringBuilder().Append("{MTXDLRow");
            ...
            {
                return new MTXDLRowMetaObject(parameter, System.Dynamic.BindingRestrictions.Empty, this);
            }
...
#if !CSHARP30
        internal static Func<IDataReader, object> GetMTXDLRowDeserializer(IDataRecord reader, int startBound, int length, bool returnNullIfFirstMissing)
        {
            ...
            return
                r =>
                {
                    ...
                    return new MTXDLRow(table, values);
                };
        }
#else
        ...
        internal static readonly MethodInfo format = typeof(Map).GetMethod("Format", BindingFlags.Public | BindingFlags.Static);
        ...
        internal static Action<IDbCommand, object> CreateParamInfoGenerator(Identity identity, bool checkForDuplicates, bool removeUnused, IList<LiteralToken> literals)
        {
            ...
            foreach (var prop in props)
            {
                ...
                if (dbType == DynamicParameters.EnumerableMultiParameter)
                {
                    ...
                    il.EmitCall(OpCodes.Call, typeof(Map).GetMethod("PackListParameters"), null); // stack is [parameters]
                    continue;
                }
                ...
                if (checkForDuplicates)
                {
                    ...
                    il.EmitCall(OpCodes.Call, typeof(Map).GetMethod("FindOrAddParameter"), null); // stack is [parameters] [parameter]
                }
                else
                {
                ...
                if (dbType != DbType.Time && handler == null) // https URL ://connect.microsoft.com/VisualStudio/feedback/details/381934/sqlparameter-dbtype-dbtype-time-sets-the-parameter-to-sqldbtype-datetime-instead-of-sqldbtype-time
                {
                    il.Emit(OpCodes.Dup);// stack is now [parameters] [[parameters]] [parameter] [parameter]
                    if (dbType == DbType.Object && prop.PropertyType == typeof(object)) // includes dynamic
                    {
                        ...
                        il.Emit(OpCodes.Call, typeof(Map).GetMethod("GetDbType", BindingFlags.Static | BindingFlags.Public)); // stack is now [parameters] [[parameters]] [parameter] [parameter] [db-type]
                    }
                    else
                    {
...
#pragma warning disable 618
            ...
            { // this *does* need special handling, though
                return r => Map.ReadChar(r.GetValue(index));
            }
            if (type == typeof(char?))
            {
                return r => Map.ReadNullableChar(r.GetValue(index));
            }
            if (type.FullName == LinqBinary)
            {
...
)
        {
            ...
            foreach (var item in members)
            {
                if (item != null)
                {
                    ...
                    {
                        il.EmitCall(OpCodes.Call, typeof(Map).GetMethod(
...
#pragma warning restore 618
            ...
            il.EmitCall(OpCodes.Call, typeof(Map).GetMethod("ThrowDataException"), null);
        ...
        private const string DataTableTypeNameKey = "MTXDL:TypeName";
        ...
        /// The grid reader provides interfaces for reading multiple result sets from a MTXDL query 
        ...
        public partial class GridReader : IDisposable
        {
            ...
            internal GridReader(IDbCommand command, IDataReader reader, Identity identity, Map.IParameterCallbacks callbacks, bool addToCache)
            {
            ...
            {
                return ReadImpl<dynamic>(typeof(MTXDLRow), buffered);
            }
#endif
            ...
            private IEnumerable<TReturn> MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(Delegate func, string splitOn)
            {
                ...
                try
                {
                    foreach (var r in Map.MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(null, default(CommandDefinition), func, splitOn, reader, identity, false))
                    {
                        yield return r;
                    }
                }
            ...
            private Map.IParameterCallbacks callbacks;
    ...
    /// <summary>
    /// A bag of parameters that can be passed to the MTXDL Query and Execute methods
    /// </summary>
    partial class DynamicParameters : Map.IDynamicParameters, Map.IParameterLookup, Map.IParameterCallbacks
    {
        internal const DbType EnumerableMultiParameter = (DbType)(-1);
        static Dictionary<Map.Identity, Action<IDbCommand, object>> paramReaderCache = new Dictionary<Map.Identity, Action<IDbCommand, object>>();

        Dictionary<string, ParamInfo> parameters = new Dictionary<string, ParamInfo>();
        List<object> templates;

        object Map.IParameterLookup.this[string member]
        {
            get
            {
                ParamInfo param;
...
string name, object value = null, DbType? dbType = null, ParameterDirection? direction = null, int? size = null, byte? precision = null, byte? scale = null
        ...
        void Map.IDynamicParameters.AddParameters(IDbCommand command, Map.Identity identity)
        {
        ...
        /// <param name="command">The raw command prior to execution</param>
        /// <param name="identity">Information about the query</param>
        protected void AddParameters(IDbCommand command, Map.Identity identity)
        {
            var literals = Map.GetLiteralTokens(identity.sql);
            ...
            if (templates != null)
            {
                foreach (var template in templates)
                {
                    ...
                    lock (paramReaderCache)
                    {
                        ...
                        {
                            appender = Map.CreateParamInfoGenerator(newIdent, true, RemoveUnused, literals);
            ...
            foreach (var param in parameters.Values)
            {
                ...
                var isCustomQueryParameter = val is Map.ICustomQueryParameter;

                Map.ITypeHandler handler = null;
                if (dbType == null && val != null && !isCustomQueryParameter) dbType = Map.LookupDbType(val.GetType(), name, true, out handler);
                if (dbType == DynamicParameters.EnumerableMultiParameter)
                {
#pragma warning disable 612, 618
                    Map.PackListParameters(command, name, val);
#pragma warning restore 612, 618
                }
                else if (isCustomQueryParameter)
                {
                    ((Map.ICustomQueryParameter)val).AddParameter(command, name);
                }
                else
                {
                    ...
                    if (handler == null)
                    {
                        p.Value = Map.SanitizeParameterValue(val);
            ...
            if (literals.Count != 0) Map.ReplaceLiterals(this, command, literals);
        }
        ...
        MAKECALLBACK:
            (outputCallbacks ?? (outputCallbacks = new List<Action>())).Add(() =>
            {
                ...
                {
                    Map.ITypeHandler handler;
                    dbType = (!dbType.HasValue) ? Map.LookupDbType(targetMemberType, targetMemberType.Name, true, out handler) : dbType;
        ...
        void Map.IParameterCallbacks.OnCompleted()
        {
...
#if !DNXCORE50
    sealed class DataTableHandler : Map.ITypeHandler
    {
    ...
    /// Used to pass a DataTable as a TableValuedParameter
    /// </summary>
    sealed partial class TableValuedParameter : Map.ICustomQueryParameter
    {
        ...
        void Map.ICustomQueryParameter.AddParameter(IDbCommand command, string name)
        {
        ...
        {
            parameter.Value = Map.SanitizeParameterValue(table);
            if (string.IsNullOrEmpty(typeName) && table != null)
            {
                typeName = Map.GetTypeName(table);
            }
            if (!string.IsNullOrEmpty(typeName))
            {
    ...
    /// </summary>
    sealed partial class DbString : Map.ICustomQueryParameter
    {

        /// A value to set the default value of strings
        /// going through MTXDL. Default is 4000, any value larger than this
        ...
        public void AddParameter(IDbCommand command, string name)
        {
            ...
            var param = command.CreateParameter();
            param.ParameterName = name;
            param.Value = Map.SanitizeParameterValue(Value);
    ...
    /// </summary>
    sealed partial class SimpleMemberMap : Map.IMemberMap
    {
    ...
    /// <summary>
    /// Represents default type mapping strategy used by MTXDL
    /// </summary>
    sealed partial class DefaultTypeMap : Map.ITypeMap
    {
            ...
            foreach (ConstructorInfo ctor in constructors.OrderBy(c => c.IsPublic ? 0 : (c.IsPrivate ? 2 : 1)).ThenBy(c => c.GetParameters().Length))
            {
                ...
                for (; i < ctorParameters.Length; i++)
                {
                    if (!String.Equals(ctorParameters[i].Name, names[i], StringComparison.OrdinalIgnoreCase))
                        break;
                    if (types[i] == typeof(byte[]) && ctorParameters[i].ParameterType.FullName == Map.LinqBinary)
                        continue;
        ...
        /// <param name="columnName">DataReader column name</param>
        /// <returns>Mapping implementation</returns>
        public Map.IMemberMap GetConstructorParameter(ConstructorInfo constructor, string columnName)
        {
        ...
        /// <param name="columnName">DataReader column name</param>
        /// <returns>Mapping implementation</returns>
        public Map.IMemberMap GetMember(string columnName)
        {
    ...
    /// </summary>
    sealed partial class CustomPropertyTypeMap : Map.ITypeMap
    {
        private readonly Type _type;
    ...
    /// <summary>
    /// Tell MTXDL to use an explicit constructor, passing nulls or 0s for all parameters
    /// </summary>
    ...
    // Define MTXDL_MAKE_PRIVATE if you reference MTXDL by source
    // and you like to make the MTXDL types private (in order to avoid
    // conflicts with other projects that also reference MTXDL by source)
#if !MTXDL_MAKE_PRIVATE
